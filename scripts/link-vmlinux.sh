...
kallsyms_step()
{
	...
	info AS ${kallsyms_S}
	gcc -nostdinc -I./arch/x86/include/generated -I/a/sources/linux/include -I/a/sources/linux/arch/x86/include/uapi -include /a/sources/linux/config.h -c -o ${kallsymso} ${kallsyms_S}
}
