...
int vma_interval_tree_insert_after;
int vma_interval_tree_iter_first;
int vma_interval_tree_iter_next;
int __acct_reclaim_writeback;
int remove_mapping;
int try_to_free_pages;
int wakeup_kswapd;
int zone_reclaimable_pages;
int delete_from_page_cache_batch;
int filemap_free_folio;
int __filemap_get_folio;
int filemap_release_folio;
int __filemap_remove_folio;
int filemap_remove_folio;
int find_get_entries;
int find_get_pages_range;
int find_get_pages_range_tag;
int find_lock_entries;
int __folio_lock;
int folio_unlock;
int lpj_fine;
int prepare_namespace;
int _copy_from_iter;
int _copy_to_iter;
int iov_iter_revert;
int copy_page;
...
int __pmd_alloc;
int print_vma_addr;
int __pte_alloc_kernel;
int __pud_alloc;
int randomize_va_space;
int unmap_mapping_folio;
int unmap_mapping_pages;
int unmap_mapping_range;
int vm_insert_page;
int __get_user_1;
int __get_user_4;
int __get_user_nocheck_8;
int __put_user_4;
int __put_user_8;
...
int system_wq;
int workqueue_init;
int wq_worker_running;
int wq_worker_sleeping;
int free_kthread_struct;
int kthreadd;
int kthreadd_task;
int kthread_set_per_cpu;
int kthread_should_stop;
int set_kthread_struct;
int tsk_fork_get_node;
int down_read;
int down_read_killable;
int down_read_trylock;
int down_write;
int down_write_killable;
int __init_rwsem;
int up_read;
int up_write;
int rt_mutex_adjust_pi;
int cad_pid;
...
int mmput;
int put_task_stack;
int __put_task_struct;
int user_mode_thread;
