...
KBUILD_CFLAGS += -DCONFIG_RCU_STALL_COMMON
KBUILD_CFLAGS += -DCONFIG_TREE_SRCU
KBUILD_CFLAGS += -DCONFIG_SRCU
KBUILD_CFLAGS += -DCONFIG_TREE_RCU
KBUILD_CFLAGS += -DCONFIG_SPARSE_IRQ
KBUILD_CFLAGS += -DCONFIG_IRQ_FORCED_THREADING
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_RESERVATION_MODE
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_MATRIX_ALLOCATOR
KBUILD_CFLAGS += -DCONFIG_IRQ_DOMAIN_HIERARCHY
KBUILD_CFLAGS += -DCONFIG_IRQ_DOMAIN
KBUILD_CFLAGS += -DCONFIG_HARDIRQS_SW_RESEND
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_MIGRATION
KBUILD_CFLAGS += -DCONFIG_GENERIC_PENDING_IRQ
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_EFFECTIVE_AFF_MASK
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_SHOW
KBUILD_CFLAGS += -DCONFIG_GENERIC_IRQ_PROBE
KBUILD_CFLAGS += -DCONFIG_SCHED_HRTICK
KBUILD_CFLAGS += -DCONFIG_HZ=1000
KBUILD_CFLAGS += -DCONFIG_HIGH_RES_TIMERS
KBUILD_CFLAGS += -DCONFIG_CONTEXT_TRACKING
KBUILD_CFLAGS += -DCONFIG_NO_HZ_FULL
KBUILD_CFLAGS += -DCONFIG_NO_HZ_COMMON
KBUILD_CFLAGS += -DCONFIG_TICK_ONESHOT
KBUILD_CFLAGS += -DCONFIG_GENERIC_CLOCKEVENTS
KBUILD_CFLAGS += -DCONFIG_GENERIC_CLOCKEVENTS_MIN_ADJUST
KBUILD_CFLAGS += -DCONFIG_GENERIC_CLOCKEVENTS_BROADCAST
KBUILD_CFLAGS += -DCONFIG_GENERIC_CMOS_UPDATE
KBUILD_CFLAGS += -DCONFIG_POSIX_CPU_TIMERS_TASK_WORK
KBUILD_CFLAGS += -DCONFIG_GENERIC_TIME_VSYSCALL
KBUILD_CFLAGS += -DCONFIG_CLOCKSOURCE_WATCHDOG_MAX_SKEW_US=1000
KBUILD_CFLAGS += -DCONFIG_CLOCKSOURCE_VALIDATE_LAST_CYCLE
KBUILD_CFLAGS += -DCONFIG_CLOCKSOURCE_WATCHDOG
KBUILD_CFLAGS += -DCONFIG_ARCH_CLOCKSOURCE_INIT
KBUILD_CFLAGS += -DCONFIG_QUEUED_SPINLOCKS
KBUILD_CFLAGS += -DCONFIG_RWSEM_SPIN_ON_OWNER
KBUILD_CFLAGS += -DCONFIG_MUTEX_SPIN_ON_OWNER
KBUILD_CFLAGS += -DCONFIG_INLINE_WRITE_UNLOCK_IRQ
KBUILD_CFLAGS += -DCONFIG_INLINE_WRITE_UNLOCK
KBUILD_CFLAGS += -DCONFIG_INLINE_READ_UNLOCK_IRQ
KBUILD_CFLAGS += -DCONFIG_INLINE_READ_UNLOCK
KBUILD_CFLAGS += -DCONFIG_INLINE_SPIN_UNLOCK_IRQ
KBUILD_CFLAGS += -DCONFIG_PREEMPT_NONE
KBUILD_CFLAGS += -DCONFIG_SECRETMEM
KBUILD_CFLAGS += -DCONFIG_ARCH_HAS_PTE_SPECIAL
KBUILD_CFLAGS += -DCONFIG_VM_EVENT_COUNTERS
KBUILD_CFLAGS += -DCONFIG_ZONE_DMA32
KBUILD_CFLAGS += -DCONFIG_ZONE_DMA
KBUILD_CFLAGS += -DCONFIG_ARCH_HAS_PTE_DEVMAP
KBUILD_CFLAGS += -DCONFIG_ARCH_HAS_VM_GET_PAGE_PROT
KBUILD_CFLAGS += -DCONFIG_ARCH_HAS_CACHE_LINE_SIZE
KBUILD_CFLAGS += -DCONFIG_GENERIC_EARLY_IOREMAP
KBUILD_CFLAGS += -DCONFIG_HAVE_SETUP_PER_CPU_AREA
KBUILD_CFLAGS += -DCONFIG_NEED_PER_CPU_PAGE_FIRST_CHUNK
KBUILD_CFLAGS += -DCONFIG_NEED_PER_CPU_EMBED_FIRST_CHUNK
KBUILD_CFLAGS += -DCONFIG_DEFAULT_MMAP_MIN_ADDR=4096
KBUILD_CFLAGS += -DCONFIG_VIRT_TO_BUS
KBUILD_CFLAGS += -DCONFIG_PHYS_ADDR_T_64BIT
KBUILD_CFLAGS += -DCONFIG_ARCH_ENABLE_SPLIT_PMD_PTLOCK
KBUILD_CFLAGS += -DCONFIG_SPLIT_PTLOCK_CPUS=4
KBUILD_CFLAGS += -DCONFIG_SPARSEMEM_EXTREME
KBUILD_CFLAGS += -DCONFIG_SPARSEMEM
KBUILD_CFLAGS += -DCONFIG_SLUB
KBUILD_CFLAGS += -DCONFIG_X86_VMX_FEATURE_NAMES
KBUILD_CFLAGS += -DCONFIG_CONFIG_IA32_FEAT_CTL
KBUILD_CFLAGS += -DCONFIG_X86_DEBUGCTLMSR
KBUILD_CFLAGS += -DCONFIG_X86_MINIMUM_CPU_FAMILY=64
KBUILD_CFLAGS += -DCONFIG_X86_CMOV
KBUILD_CFLAGS += -DCONFIG_X86_CMPXCHG64
KBUILD_CFLAGS += -DCONFIG_X86_TSC
KBUILD_CFLAGS += -DCONFIG_X86_L1_CACHE_SHIFT=6
KBUILD_CFLAGS += -DCONFIG_X86_INTERNODE_CACHE_SHIFT=6
KBUILD_CFLAGS += -DCONFIG_CPU_SUP_AMD
